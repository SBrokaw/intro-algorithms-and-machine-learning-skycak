from ch1_1_hello_world import * #check_if_symmetric, convert_to_numbers, convert_to_chars, get_intersection, get_union, count_characters
...
print("=".center(50, '='))
print(" Chapter 1.1 and 1.2 Tests ".center(50, '='))
print("=".center(50, '='))
